        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none">
          <div className="flex gap-4 rotate-12 scale-150">
            {filmFrames.map((_, i) => (
              <div
                key={i}
                className="w-20 h-16 border-4 border-foreground rounded-lg"
              />
            ))}
          </div>
        </div>
        ...
        <div className="text-center max-w-lg relative z-10">
          ...
          >
            <div className="relative">
              ...
              >
                <span className="text-6xl sm:text-7xl font-black text-primary-foreground">
                  404
                </span>
              </motion.div>
              <motion.div
          ...
          >
            ...
            <p className="text-muted-foreground mb-10 text-base leading-relaxed max-w-sm mx-auto">
              This scene was left on the cutting room floor. Let's get you back
              to the show.
            </p>
          </motion.div>
