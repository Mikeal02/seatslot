...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      {/* Gradient orbs */}
      <motion.div 
        className="absolute top-0 left-0 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      />
      <motion.div 
        className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-accent/20 rounded-full blur-[100px] translate-x-1/2 translate-y-1/2"
        animate={{
          scale: [1.2, 1, 1.2],
          opacity: [0.3, 0.5, 0.3],
        }}
            ...
            <Tabs defaultValue="signin" className="w-full">
              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full cinema-gradient btn-professional h-11 text-sm font-medium shadow-lg shadow-primary/25" 
                    disabled={loading}
                  >
                    {loading ? 'Signing in...' : (
                      <>
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full h-11 bg-background/50 hover:bg-muted"
