...
export function CastCarousel({ cast, director, composers, cinematographers }: CastCarouselProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Director + Key Crew */}
      {(director || (composers && composers.length > 0) || (cinematographers && cinematographers.length > 0)) && (
      ...
      <div className="flex gap-3 overflow-x-auto pb-3 scrollbar-thin">
        {detailed
          ? (cast as CastMember[]).map((member, i) => (
              ...
              >
                <div className="w-[85px] h-[85px] mx-auto rounded-full overflow-hidden bg-muted border-2 border-border/30 group-hover:border-primary/40 transition-all duration-300 mb-2 relative">
                  {member.photo ? (
