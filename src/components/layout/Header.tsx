            ...
            >
              <div className="container mx-auto px-4 py-6 space-y-6">
                ...
                <div className="space-y-1">
                  <p className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold px-4 mb-2">
                    Navigate
                  </p>
                  {navItems.map((link, i) => (
                    <motion.div
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <link.icon
                            className={`h-4.5 w-4.5 ${isActive(link.href) ? "text-primary-foreground" : "text-muted-foreground"}`}
                          />
                        </div>
                    ...
                    {isAdmin && (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Shield
                              className={`h-4.5 w-4.5 ${location.pathname.startsWith("/admin") ? "text-primary-foreground" : "text-muted-foreground"}`}
                            />
                          </div>
                          <span className="text-base font-semibold">
                            Admin Panel
