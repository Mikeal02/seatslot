...
export function MetaTags({
  ...
  useEffect(() => {
    ...
    const fullTitle = title
      ? `${title} | CineBook`
      : "CineBook | Book Movie Tickets Online";
    ...
    updateMetaTag(
      "description",
      description ||
        "Your ultimate destination for seamless movie ticket booking. Browse films, select seats, and book tickets instantly.",
    );
    ...
    updateMetaTag(
      "og:type",
      type === "movie" ? "video.movie" : "website",
      "property",
    );
    if (image) {
