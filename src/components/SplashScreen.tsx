  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
        ...
        exit={{ opacity: 0 }}
        animate={
          phase === "exit" ? { opacity: 0, scale: 1.05 } : { opacity: 1 }
        }
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, hsl(var(--primary) / 0.15) 0%, hsl(var(--accent) / 0.08) 40%, transparent 70%)",
            }}
        ...
        <div className="relative flex flex-col items-center gap-6">
          ...
          <motion.div
            ...
            animate={
              phase !== "logo" ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
            }
            transition={{ duration: 0.5, ease: [0.25, 0.1, 0.25, 1] }}
          >
            ...
            <motion.p
              ...
              animate={
                phase !== "logo" ? { opacity: 1, letterSpacing: "0.3em" } : {}
              }
